...
export class GeneracionRecibosDerechosPecuniarios {
  ...
  displayedColumns: string[] = ['Periodo', 'Id', 'FechaCreacion', 'Valor', 'Concepto', 'FechaOrdinaria', 'ValorPagado', 'FechaPago', 'Estado', 'VerRecibo', 'Pagar', 'AdjuntarPago', 'Solicitar', 'VerRespuesta'];
  priceColumns: string[] = ['Valor', 'ValorPagado']
  actionColumns: string[] = ['VerRecibo', 'Pagar', 'AdjuntarPago', 'Solicitar', 'VerRespuesta']
  nombresColumnas = []
  ...
  constructor(
    ...
    this.nombresColumnas["FechaOrdinaria"] = "derechos_pecuniarios.fecha_ordinaria";
    ...
    if (this.info_persona_id !== undefined && this.info_persona_id !== 0 &&
      ...
      this.sgaMidService.get('derechos_pecuniarios/consultar_persona/' + this.info_persona_id).subscribe(async (res: any) => {
        ...
        (error: HttpErrorResponse) => {
          this.loading = false;
          this.popUpManager.showErrorAlert(this.translate.instant('ERROR.' + error.status), this.translate.instant('GLOBAL.cargar') + '-' +
